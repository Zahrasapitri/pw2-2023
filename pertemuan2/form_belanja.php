    ...
    <form method="GET" action="form_belanja.php" class="w-75 mt-5 mx-auto p-4 border shadow-sm">
        ...
        <div class="container px-3">
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input name="custname" placeholder="Masukan nama customer" type="text" class="form-control" required>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="produk" value="baju" type="radio" class="custom-control-input" required>
                        <label for="baju" class="custom-control-label">Baju</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="produk" value="topi" type="radio" class="custom-control-input" required>
                        <label for="topi" class="custom-control-label">Topi</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="produk" value="jamtangan" type="radio" class="custom-control-input" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input name="jumlah" placeholder="Jumlah beli" type="number" min=0 class="form-control" required>
                </div>
            </div>
            <div class="form-group row">
